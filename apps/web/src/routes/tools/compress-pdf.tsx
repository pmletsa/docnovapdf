    ...
    <div className="min-h-screen bg-[#f8f9fb] flex flex-col">
      ...
      <main className="flex-1 px-6 py-8 lg:py-10">
        <div className="max-w-3xl mx-auto">
          ...
          {/* Header */}
          <div className="mb-8">
            <h1 className="text-3xl font-black text-gray-900 mb-2">Compress PDF</h1>
          ...
          >
            ...
            <p className="text-gray-500 text-sm mb-6 max-w-xs">
              Select a PDF file from your computer to<br />compress and reduce its size.
            </p>
          ...
          {file && (
            <>
              ...
              {/* Compression Level */}
              <div className="mb-8">
                <h3 className="text-sm font-bold text-gray-800 mb-3">Compression Level</h3>
                ...
                {isProcessing && (
                  <div className="w-full max-w-md mt-6">
                    <div className="flex justify-between text-xs font-medium mb-2">
                      <span className="text-gray-500">Compressing...</span>

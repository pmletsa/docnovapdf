      ...
      <main className="flex-1 px-6 py-8 lg:py-10">
        <div className="max-w-3xl mx-auto">
          ...
          <nav className="flex items-center gap-2 text-sm mb-6 text-gray-500">
            ...
            <span className="text-gray-700">JPG to PDF</span>
          </nav>

          {/* Header */}
          <div className="mb-8">
            <h1 className="text-3xl font-black text-gray-900 mb-2">JPG to PDF</h1>
            <p className="text-gray-600 text-base">
              Convert JPG images to PDF. Combine multiple images into a single PDF document.
            </p>
          </div>
          ...
          >
            ...
            <h3 className="text-lg font-bold text-gray-900 mb-2">Drag & Drop images here</h3>
            <p className="text-gray-500 text-sm mb-6 max-w-xs">
              Select JPG or PNG images from your computer<br />to combine into a PDF.
            </p>

    ...
    <div className="min-h-screen bg-[#f8f9fb] flex flex-col">
      ...
      <main className="flex-1 px-6 py-[22px] lg:py-10">
        <div className="max-w-3xl mx-auto">
          ...
          {/* Header */}
          <div className="mb-8">
            <h1 className="text-3xl font-black text-gray-900 mb-2">Merge PDF</h1>
            <p className="text-gray-600 text-base">
              Combine multiple PDF files into one professional document in seconds.
            </p>
          </div>
          ...
          >
            ...
            <p className="text-gray-500 text-sm mb-6 max-w-xs">
              Select multiple PDF files from your computer or<br />cloud storage to merge them.
            </p>
            ...
            <>
              ...
              <div className="space-y-3 mb-8">
                {files.map((file, index) => (
                  <div key={index} className="bg-white p-4 rounded-xl border border-gray-100 flex items-center gap-4 shadow-sm hover:shadow-md transition-all">
                    <div className="cursor-grab text-gray-300 hover:text-gray-400 flex flex-col gap-0.5">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-gray-500">{formatBytes(file.size)} • {Math.ceil(file.size / 50000)} Pages</p>
                    </div>
                    <button 
                ...
                {isProcessing && (
                  <div className="w-full max-w-md mt-6">
                    <div className="flex justify-between text-xs font-medium mb-2">
                      <span className="text-gray-500">Processing files...</span>

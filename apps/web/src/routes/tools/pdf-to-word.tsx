      ...
      <main className="flex-1 px-6 py-[22px] lg:py-10">
        <div className="max-w-3xl mx-auto">
          ...
          <nav className="flex items-center gap-2 text-sm mb-6 text-gray-500">
            ...
            <span className="text-gray-700">PDF to Word</span>
          </nav>

          {/* Header */}
          <div className="mb-8">
            <h1 className="text-3xl font-black text-gray-900 mb-2">PDF to Word</h1>
            <p className="text-gray-600 text-base">
              Convert PDF documents to editable Word files. Preserves formatting and layout perfectly.
            </p>
          </div>
          ...
          >
            ...
            <p className="text-gray-500 text-sm mb-6 max-w-xs">
              Select a PDF file from your computer to<br />convert to Word format.
            </p>

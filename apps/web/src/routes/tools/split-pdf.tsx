      ...
      <main className="flex-1 px-6 py-8 lg:py-10">
        <div className="max-w-3xl mx-auto">
          ...
          <nav className="flex items-center gap-2 text-sm mb-6 text-gray-500">
            ...
            <span className="text-gray-700">Split PDF</span>
          </nav>

          {/* Header */}
          <div className="mb-8">
            <h1 className="text-3xl font-black text-gray-900 mb-2">Split PDF</h1>
            <p className="text-gray-600 text-base">
              Separate PDF pages into multiple files. Extract specific pages or split by range.
            </p>
          </div>
          ...
          >
            ...
            <p className="text-gray-500 text-sm mb-6 max-w-xs">
              Select a PDF file from your computer to<br />split into multiple files.
            </p>
          ...
          {file && (
            <>
              ...
              {/* Split Mode */}
              <div className="mb-8">
                <h3 className="text-sm font-bold text-gray-800 mb-3">Split Mode</h3>
                <div className="grid grid-cols-2 gap-3">
                  <button
                    ...
                    className={`p-4 rounded-xl border-2 text-left transition-all ${
                      splitMode === 'pages' 
                        ...
                        : 'border-gray-200 hover:border-[#e53935]/30 bg-white'
                    }`}
                  >
                    <span className={`font-semibold text-sm ${splitMode === 'pages' ? 'text-[#e53935]' : 'text-gray-900'}`}>Extract All Pages</span>
                    <p className="text-xs text-gray-500 mt-1">Split into individual pages</p>
                  </button>
                  <button
                  ...
                  >
                    <span className={`font-semibold text-sm ${splitMode === 'range' ? 'text-[#e53935]' : 'text-gray-900'}`}>Custom Range</span>
                    <p className="text-xs text-gray-500 mt-1">Select specific pages</p>
                  </button>
                </div>
              </div>
                ...
                {isProcessing && (
                  <div className="w-full max-w-md mt-6">
                    <div className="flex justify-between text-xs font-medium mb-2">
                      <span className="text-gray-500">Splitting...</span>

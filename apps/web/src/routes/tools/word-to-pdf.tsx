      ...
      <main className="flex-1 px-6 py-[22px] lg:py-10">
        <div className="max-w-3xl mx-auto">
          ...
          <nav className="flex items-center gap-2 text-sm mb-6 text-gray-500">
            ...
            <span className="text-gray-700">Word to PDF</span>
          </nav>
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600 text-base">
              Convert Word documents to PDF format. Preserves formatting and layout perfectly.
            </p>
          </div>
          ...
          >
            ...
            <h3 className="text-lg font-bold text-gray-900 mb-2">Drag & Drop your Word file here</h3>
            <p className="text-gray-500 text-sm mb-6 max-w-xs">
              Select a Word document from your computer to<br />convert to PDF format.
            </p>
              ...
              <div className="space-y-3 mb-8">
                <div className="bg-white p-4 rounded-xl border border-gray-100 flex items-center gap-4 shadow-sm hover:shadow-md transition-all">
                  <div className="w-10 h-10 rounded-lg bg-[#e3f2fd] flex items-center justify-center flex-shrink-0">
                    <svg className="w-6 h-6 text-[#1976d2]" viewBox="0 0 24 24" fill="currentColor">

...
export const Route = createFileRoute('/tools/ocr-pdf')({
      ...
      <main className="flex-1 px-6 py-[22px] lg:py-10">
        <div className="max-w-3xl mx-auto">
          ...
          <nav className="flex items-center gap-2 text-sm mb-6 text-gray-500">
            ...
            <span className="text-gray-700">OCR PDF</span>
          </nav>

          {/* Header */}
          <div className="mb-8">
            <h1 className="text-3xl font-black text-gray-900 mb-2">OCR PDF</h1>
          ...
          >
            ...
            <h3 className="text-lg font-bold text-gray-900 mb-2">Drag & Drop your file here</h3>
            <p className="text-gray-500 text-sm mb-6 max-w-xs">
              Select a scanned PDF or image from your<br />computer to extract text.
            </p>
          ...
          {file && (
            <>
              ...
              {/* Language Selection */}
              <div className="mb-8">
                <h3 className="text-sm font-bold text-gray-800 mb-3">Document Language</h3>
                <select
                  value={language}
                  onChange={(e) => setLanguage(e.target.value)}
                  className="w-full p-3 border border-gray-200 rounded-xl bg-white text-gray-900 focus:border-[#e53935] focus:outline-none focus:ring-1 focus:ring-[#e53935]/20 text-sm"
                >
                  {languages.map((lang) => (
                ...
                {isProcessing && (
                  <div className="w-full max-w-md mt-6">
                    <div className="flex justify-between text-xs font-medium mb-2">
                      <span className="text-gray-500">Processing OCR...</span>

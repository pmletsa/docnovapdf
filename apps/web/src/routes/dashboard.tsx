      ...
      <div className="p-8">
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-gray-500">You have 4 documents currently being processed by AI.</p>
            </div>
            <div className="flex gap-3">
              ...
              <button className="flex items-center gap-2 px-4 py-2.5 bg-[#e53935] text-white rounded-xl font-medium hover:bg-[#d32f2f] transition-colors cursor-pointer">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div className="bg-white p-6 rounded-xl border border-gray-100">
              ...
              <p className="text-sm text-[#e53935] mt-3 font-medium">Documents summarized today</p>
            ...
            <div className="bg-white p-6 rounded-xl border border-gray-100">
              <div className="flex items-start justify-between">
                <div>
                  <p className="text-sm text-gray-500 mb-1">Automation Success</p>
              ...
              <p className="text-sm text-[#4caf50] mt-3 font-medium flex items-center gap-1">
            ...
            <div className="bg-white p-6 rounded-xl border border-gray-100">
              ...
              <p className="text-sm text-gray-500 mt-3">Total this month</p>
            </div>
          </div>

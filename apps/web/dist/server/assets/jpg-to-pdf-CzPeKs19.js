  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-[#f8f9fb] flex flex-col", children: [
    ...
    /* @__PURE__ */ jsx("main", { className: "flex-1 px-6 py-8 lg:py-10", children: /* @__PURE__ */ jsxs("div", { className: "max-w-3xl mx-auto", children: [
      /* @__PURE__ */ jsxs("nav", { className: "flex items-center gap-2 text-sm mb-6 text-gray-500", children: [
        ...
        /* @__PURE__ */ jsx("span", { className: "text-gray-700", children: "JPG to PDF" })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "mb-8", children: [
        /* @__PURE__ */ jsx("h1", { className: "text-3xl font-black text-gray-900 mb-2", children: "JPG to PDF" }),
        /* @__PURE__ */ jsx("p", { className: "text-gray-600 text-base", children: "Convert JPG images to PDF. Combine multiple images into a single PDF document." })
      ] }),
      /* @__PURE__ */ jsxs("div", { onClick: () => fileInputRef.current?.click(), className: "bg-[#fffbfb] rounded-xl border-2 border-dashed border-[#e53935]/30 p-10 flex flex-col items-center justify-center text-center cursor-pointer hover:border-[#e53935]/50 transition-all mb-10", children: [
        /* @__PURE__ */ jsx("input", { ref: fileInputRef, type: "file", accept: ".jpg,.jpeg,.png", multiple: true, onChange: handleFileSelect, className: "hidden" }),
        ...
        /* @__PURE__ */ jsx("h3", { className: "text-lg font-bold text-gray-900 mb-2", children: "Drag & Drop images here" }),
        /* @__PURE__ */ jsxs("p", { className: "text-gray-500 text-sm mb-6 max-w-xs", children: [
          "Select JPG or PNG images from your computer",
          /* @__PURE__ */ jsx("br", {}),
      ...
      files.length > 0 && /* @__PURE__ */ jsxs(Fragment, { children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-4", children: [
          /* @__PURE__ */ jsxs("h3", { className: "text-sm font-bold flex items-center gap-2 text-gray-800", children: [
            /* @__PURE__ */ jsx("svg", { className: "w-5 h-5 text-gray-600", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M4 6h16M4 10h16M4 14h16M4 18h16" }) }),
            "Images to Convert (",
            files.length,
            ")"
          ] }),
          /* @__PURE__ */ jsx("button", { onClick: () => fileInputRef.current?.click(), className: "text-[#e53935] text-sm font-semibold hover:underline", children: "+ Add More" })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "space-y-3 mb-8", children: files.map((file, index) => /* @__PURE__ */ jsxs("div", { className: "bg-white p-4 rounded-xl border border-gray-100 flex items-center gap-4 shadow-sm hover:shadow-md transition-all", children: [
          /* @__PURE__ */ jsxs("div", { className: "cursor-grab text-gray-300 hover:text-gray-400 flex flex-col gap-0.5", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex gap-0.5", children: [
              /* @__PURE__ */ jsx("span", { className: "w-1 h-1 bg-current rounded-full" }),
              /* @__PURE__ */ jsx("span", { className: "w-1 h-1 bg-current rounded-full" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "flex gap-0.5", children: [
              /* @__PURE__ */ jsx("span", { className: "w-1 h-1 bg-current rounded-full" }),
          ...
          /* @__PURE__ */ jsx("div", { className: "w-10 h-10 rounded-lg bg-[#e3f2fd] flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxs("svg", { className: "w-6 h-6 text-[#1976d2]", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: [
          ...
          /* @__PURE__ */ jsx("button", { onClick: () => handleRemoveFile(index), className: "p-2 text-gray-300 hover:text-gray-500 transition-colors", children: /* @__PURE__ */ jsx("svg", { className: "w-5 h-5", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 1.5, d: "M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" }) }) })
        ] }, index)) }),
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center", children: [
          /* @__PURE__ */ jsxs("button", { onClick: handleConvert, disabled: isProcessing, className: "bg-[#e53935] hover:bg-[#d32f2f] text-white font-semibold py-3.5 px-10 rounded-full text-base flex items-center justify-center gap-2 shadow-lg hover:shadow-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed", children: [
            "Convert to PDF",
          ...
          isProcessing && /* @__PURE__ */ jsxs("div", { className: "w-full max-w-md mt-6", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex justify-between text-xs font-medium mb-2", children: [
              /* @__PURE__ */ jsx("span", { className: "text-gray-500", children: "Converting..." }),

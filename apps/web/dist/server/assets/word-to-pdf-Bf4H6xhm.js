  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-[#f8f9fb] flex flex-col", children: [
    ...
    /* @__PURE__ */ jsx("main", { className: "flex-1 px-6 py-8 lg:py-10", children: /* @__PURE__ */ jsxs("div", { className: "max-w-3xl mx-auto", children: [
      /* @__PURE__ */ jsxs("nav", { className: "flex items-center gap-2 text-sm mb-6 text-gray-500", children: [
        ...
        /* @__PURE__ */ jsx("span", { className: "text-gray-700", children: "Word to PDF" })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "mb-8", children: [
        /* @__PURE__ */ jsx("h1", { className: "text-3xl font-black text-gray-900 mb-2", children: "Word to PDF" }),
        /* @__PURE__ */ jsx("p", { className: "text-gray-600 text-base", children: "Convert Word documents to PDF format. Preserves formatting and layout perfectly." })
      ] }),
      /* @__PURE__ */ jsxs("div", { onClick: () => fileInputRef.current?.click(), className: "bg-[#fffbfb] rounded-xl border-2 border-dashed border-[#e53935]/30 p-10 flex flex-col items-center justify-center text-center cursor-pointer hover:border-[#e53935]/50 transition-all mb-10", children: [
        /* @__PURE__ */ jsx("input", { ref: fileInputRef, type: "file", accept: ".doc,.docx", onChange: handleFileSelect, className: "hidden" }),
        ...
        /* @__PURE__ */ jsx("h3", { className: "text-lg font-bold text-gray-900 mb-2", children: "Drag & Drop your Word file here" }),
        /* @__PURE__ */ jsxs("p", { className: "text-gray-500 text-sm mb-6 max-w-xs", children: [
          "Select a Word document from your computer to",
          /* @__PURE__ */ jsx("br", {}),
      ...
      file && /* @__PURE__ */ jsxs(Fragment, { children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "space-y-3 mb-8", children: /* @__PURE__ */ jsxs("div", { className: "bg-white p-4 rounded-xl border border-gray-100 flex items-center gap-4 shadow-sm hover:shadow-md transition-all", children: [
          /* @__PURE__ */ jsx("div", { className: "w-10 h-10 rounded-lg bg-[#e3f2fd] flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsx("svg", { className: "w-6 h-6 text-[#1976d2]", viewBox: "0 0 24 24", fill: "currentColor", children: /* @__PURE__ */ jsx("path", { d: "M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8l-6-6zm-1 2l5 5h-5V4zM8.5 13h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1 0-1zm0 2h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1 0-1zm0 2h4a.5.5 0 0 1 0 1h-4a.5.5 0 0 1 0-1z" }) }) }),

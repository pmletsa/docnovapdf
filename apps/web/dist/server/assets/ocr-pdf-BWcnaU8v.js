  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-[#f8f9fb] flex flex-col", children: [
    ...
    /* @__PURE__ */ jsx("main", { className: "flex-1 px-6 py-8 lg:py-10", children: /* @__PURE__ */ jsxs("div", { className: "max-w-3xl mx-auto", children: [
      /* @__PURE__ */ jsxs("nav", { className: "flex items-center gap-2 text-sm mb-6 text-gray-500", children: [
        ...
        /* @__PURE__ */ jsx("span", { className: "text-gray-700", children: "OCR PDF" })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "mb-8", children: [
        /* @__PURE__ */ jsx("h1", { className: "text-3xl font-black text-gray-900 mb-2", children: "OCR PDF" }),
        /* @__PURE__ */ jsx("p", { className: "text-gray-600 text-base", children: "Extract text from scanned PDFs and images using advanced OCR technology." })
      ] }),
      /* @__PURE__ */ jsxs("div", { onClick: () => fileInputRef.current?.click(), className: "bg-[#fffbfb] rounded-xl border-2 border-dashed border-[#e53935]/30 p-10 flex flex-col items-center justify-center text-center cursor-pointer hover:border-[#e53935]/50 transition-all mb-10", children: [
        /* @__PURE__ */ jsx("input", { ref: fileInputRef, type: "file", accept: ".pdf,.jpg,.jpeg,.png", onChange: handleFileSelect, className: "hidden" }),
        ...
        /* @__PURE__ */ jsx("h3", { className: "text-lg font-bold text-gray-900 mb-2", children: "Drag & Drop your file here" }),
        /* @__PURE__ */ jsxs("p", { className: "text-gray-500 text-sm mb-6 max-w-xs", children: [
          "Select a scanned PDF or image from your",
          /* @__PURE__ */ jsx("br", {}),
          "computer to extract text."
        ] }),
      ...
      file && /* @__PURE__ */ jsxs(Fragment, { children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "mb-8", children: [
          /* @__PURE__ */ jsx("h3", { className: "text-sm font-bold text-gray-800 mb-3", children: "Document Language" }),
          /* @__PURE__ */ jsx("select", { value: language, onChange: (e) => setLanguage(e.target.value), className: "w-full p-3 border border-gray-200 rounded-xl bg-white text-gray-900 focus:border-[#e53935] focus:outline-none focus:ring-1 focus:ring-[#e53935]/20 text-sm", children: languages.map((lang) => /* @__PURE__ */ jsx("option", { value: lang.code, children: lang.name }, lang.code)) })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center", children: [
          /* @__PURE__ */ jsxs("button", { onClick: handleOcr, disabled: isProcessing, className: "bg-[#e53935] hover:bg-[#d32f2f] text-white font-semibold py-3.5 px-10 rounded-full text-base flex items-center justify-center gap-2 shadow-lg hover:shadow-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed", children: [
            "Extract Text",
          ...
          isProcessing && /* @__PURE__ */ jsxs("div", { className: "w-full max-w-md mt-6", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex justify-between text-xs font-medium mb-2", children: [
              /* @__PURE__ */ jsx("span", { className: "text-gray-500", children: "Processing OCR..." }),

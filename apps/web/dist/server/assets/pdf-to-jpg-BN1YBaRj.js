  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-[#f8f9fb] flex flex-col", children: [
    ...
    /* @__PURE__ */ jsx("main", { className: "flex-1 px-6 py-8 lg:py-10", children: /* @__PURE__ */ jsxs("div", { className: "max-w-3xl mx-auto", children: [
      /* @__PURE__ */ jsxs("nav", { className: "flex items-center gap-2 text-sm mb-6 text-gray-500", children: [
        ...
        /* @__PURE__ */ jsx("span", { className: "text-gray-700", children: "PDF to JPG" })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "mb-8", children: [
        /* @__PURE__ */ jsx("h1", { className: "text-3xl font-black text-gray-900 mb-2", children: "PDF to JPG" }),
        /* @__PURE__ */ jsx("p", { className: "text-gray-600 text-base", children: "Convert PDF pages to high-quality JPG images. Perfect for sharing and presentations." })
      ] }),
      ...
      file && /* @__PURE__ */ jsxs(Fragment, { children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "mb-8", children: [
          /* @__PURE__ */ jsx("h3", { className: "text-sm font-bold text-gray-800 mb-3", children: "Image Quality" }),
          /* @__PURE__ */ jsx("div", { className: "grid grid-cols-3 gap-3", children: ["low", "medium", "high"].map((q) => /* @__PURE__ */ jsx("button", { onClick: () => setQuality(q), className: `p-4 rounded-xl border-2 capitalize transition-all text-sm font-medium ${quality === q ? "border-[#e53935] bg-[#ffebee] text-[#e53935]" : "border-gray-200 hover:border-[#e53935]/30 text-gray-700 bg-white"}`, children: q }, q)) })
        ] }),

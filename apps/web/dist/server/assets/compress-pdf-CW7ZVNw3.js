  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-[#f8f9fb] flex flex-col", children: [
    ...
    /* @__PURE__ */ jsx("main", { className: "flex-1 px-6 py-8 lg:py-10", children: /* @__PURE__ */ jsxs("div", { className: "max-w-3xl mx-auto", children: [
      /* @__PURE__ */ jsxs("nav", { className: "flex items-center gap-2 text-sm mb-6 text-gray-500", children: [
        ...
        /* @__PURE__ */ jsx("span", { className: "text-gray-700", children: "Compress PDF" })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "mb-8", children: [
        /* @__PURE__ */ jsx("h1", { className: "text-3xl font-black text-gray-900 mb-2", children: "Compress PDF" }),
        /* @__PURE__ */ jsx("p", { className: "text-gray-600 text-base", children: "Reduce PDF file size while maintaining quality. Perfect for email attachments and web uploads." })
      ] }),
      ...
      file && /* @__PURE__ */ jsxs(Fragment, { children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "mb-8", children: [
          /* @__PURE__ */ jsx("h3", { className: "text-sm font-bold text-gray-800 mb-3", children: "Compression Level" }),
          /* @__PURE__ */ jsx("div", { className: "grid grid-cols-3 gap-3", children: ["low", "medium", "high"].map((level) => /* @__PURE__ */ jsx("button", { onClick: () => setCompressionLevel(level), className: `p-4 rounded-xl border-2 capitalize transition-all text-sm font-medium ${compressionLevel === level ? "border-[#e53935] bg-[#ffebee] text-[#e53935]" : "border-gray-200 hover:border-[#e53935]/30 text-gray-700 bg-white"}`, children: level }, level)) })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center", children: [
          /* @__PURE__ */ jsxs("button", { onClick: handleCompress, disabled: isProcessing, className: "bg-[#e53935] hover:bg-[#d32f2f] text-white font-semibold py-3.5 px-10 rounded-full text-base flex items-center justify-center gap-2 shadow-lg hover:shadow-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed", children: [
            "Compress PDF",
          ...
          isProcessing && /* @__PURE__ */ jsxs("div", { className: "w-full max-w-md mt-6", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex justify-between text-xs font-medium mb-2", children: [
              /* @__PURE__ */ jsx("span", { className: "text-gray-500", children: "Compressing..." }),
